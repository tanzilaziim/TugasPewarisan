public class iPhone implements Phone{
    // Kelas iPhone memiliki koneksi dengan interface Phone
    private int volume = 60; //Deklarasi variabel volume dengan nilai 60
    ...
    public void powerOn() {
        ...
        System.out.println("Powered by IOS");
    }
    ...
    public void volumeDown(){ //Override metode volumeDown
        if (isPowerOn){ //Cek kondisi apakah phone hidup atau mati
            ...
            if(volume > MIN_VOLUME) {
                ...
                volume-=10; //Operasi dimana setiap pengurangan volume berkurang 10
    ...
    public void volumeUp(){ //Override metode volumeUp
        if (isPowerOn){//Cek kondisi apakah phone hidup atau mati
            ...
            if(volume < MAX_VOLUME) {
                ...
                volume+=10; //Operasi dimana setiap penambahan volume bertambah 10
